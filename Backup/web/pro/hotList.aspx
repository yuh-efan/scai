<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="hotList.aspx.cs" Inherits="WZ.Web.pro.hotList" %>
...
<div class="current"><w:CurrentPath ID="curPath" runat="server" Text=" &gt; 热卖" /></div>
<div class="main">
  <div class="left">
...
<w:cycle id="rpList" runat="server" width="107" height="80" />        </ul>
        
        <ul class="def d_list2 d_list_hotSell" id="showPic" runat="server">
