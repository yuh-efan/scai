<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="salePromotionList.aspx.cs" Inherits="WZ.Web.pro.salePromotionList" %>
...
<div class="current"><w:CurrentPath ID="curPath" runat="server" Text=" &gt; 促销 SALE" /></div>
<div class="main">
  <div class="left">
...
<w:cycle id="rpMS" runat="server" width="107" height="80" />
...
<w:cycle id="rpList" runat="server" width="107" height="80" />
        ...
        <ul class="def d_list2 d_list_sale" id="showPic" runat="server">
