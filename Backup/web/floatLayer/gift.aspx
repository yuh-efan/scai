<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gift.aspx.cs" Inherits="WZ.Web.floatLayer.gift" %>
...
{
    Ajax('/ajax/gift.aspx?t=1&id='+pID+'&excount='+_.get('excount').value,{
	fnSuccess:function()
	{
	    ...
	    switch(jso.type)
		{
		    ...
		    case 'success':
				location.href='gift1.aspx?id=<%=id %>&num='+_.get('excount').value;
...
<body>
    ...
    <ul class="right">
        ...
        <li>所需积分：<strong class="Red3"><%=d.Eval("Integral")%></strong>分/件</li>
    	<li>兑换数量：<input type="text" id="excount" name="excount" style="width:50px;" value="1" maxlength="9" />件</li>
        <li>
        <input type="button" class="sun" onclick="Exchange(<%=d.Eval("GiftSN")%>)" value="立即兑换" />
        
        <div id="htm_msg" style="color:#f00; line-height:30px;">&nbsp;</div></li>
