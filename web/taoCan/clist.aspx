<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="clist.aspx.cs" Inherits="WZ.Web.taoCan.clist" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title><%=pageClassName %></title>
...
<ItemTemplate>
<li> <a href="<%#GetURL.TaoCan.Info(Eval("ProSN")) %>" class="products-pic" target="_blank"><img src="<%#GetURL.TaoCan.Pic(Eval("PicS")) %>" width="107" height="80" alt="<%#Eval("ProName")%>" /></a>
...
<ItemTemplate>
<li> <a href="<%#GetURL.TaoCan.Info(Eval("ProSN")) %>" class="products-pic2" target="_blank"><img src="<%#GetURL.TaoCan.Pic(Eval("PicS")) %>" width="107" height="80" alt="<%#Eval("ProName")%>" /></a>
            <div class="calss-left">
              <h5><a href="<%#GetURL.TaoCan.Info(Eval("ProSN")) %>" class="Blue" target="_blank"><%#Eval("ProName")%></a></h5>
              <ul class="left-txt">
