<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="clist.aspx.cs" Inherits="WZ.Web.caiPu.clist" %>
...
<div class="main">
  ...
  <div class="right">
    <div class="Hot-main" id="htm_TJ" runat="server">
      <h1></h1>
<div class="border">
<ul class="def d_list1">
<w:cycle id="rpTJ" runat="server" width="107" height="80" />
</ul>
</div>
    </div>
    <div class="ch-main">
