<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="product.aspx.cs" Inherits="WZ.Web.search.product"%>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>搜索商品 <%=keyword%></title>
...
<div class="current"><w:CurrentPath ID="curPath" runat="server" Text=' > 商品搜索 ' /></div>
<div class="main">
  <div class="left">
