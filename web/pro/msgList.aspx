<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="msgList.aspx.cs" Inherits="WZ.Web.pro.msgList" %>
  ...
  <div class="reviews">
    ...
    <div class="comment">
     ...
     <w:Item ID="rpList" runat="server">
        ...
        <div class="com-left">
          <h3><span><%# Eval("AddDate")%></span><strong><%# Eval("UserName")%></strong>：</h3>
      ...
      <div class="Sub-box">
        ...
        <script type="text/javascript">
			...
			function msgSubmit()
			{
				...
				Ajax("/ajax/proMsg.aspx?id=<%=id%>&t=1",{
